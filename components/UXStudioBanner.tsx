  ...
  return (
    <section className="relative py-32 bg-[#1A1A1A] overflow-hidden group">
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full opacity-10 pointer-events-none">
        <svg viewBox="0 0 100 100" className="w-full h-full text-[#4918A9]" fill="currentColor">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="accent-bar bg-[#D9D1DB]"></div>
            <span className="text-[11px] font-black uppercase tracking-[0.4em] text-[#D9D1DB] mb-6 block">Specialized Studio</span>
            <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter leading-[0.9] mb-8">
              Antern <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D9D1DB] to-[#4918A9]">UX Studio</span>
            </h2>
            ...
            >
              Know Details
              <div className="w-12 h-px bg-white group-hover:w-24 group-hover:bg-[#D9D1DB] transition-all duration-700"></div>
              <svg className="w-6 h-6 text-[#D9D1DB]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="relative w-full aspect-square lg:aspect-video overflow-hidden border border-white/10 shadow-2xl">
            ...
            <div className="absolute inset-0 pointer-events-none opacity-20 group-hover:opacity-10 transition-opacity duration-1000" 
                 style={{ backgroundImage: 'radial-gradient(#4918A9 1px, transparent 1px)', backgroundSize: '20px 20px' }}>
            </div>
          </div>
        </div>
      </div>
