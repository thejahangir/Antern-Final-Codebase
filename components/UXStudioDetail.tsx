    ...
    <div className="bg-white">
      ...
      <section className="relative h-[90vh] min-h-[700px] flex items-center bg-[#1A1A1A] text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          <div className="max-w-4xl">
            <div className="accent-bar bg-gradient-to-r from-[#D9D1DB] to-[#4918A9] w-32 h-1.5 mb-12"></div>
            <span className="text-[12px] font-black uppercase tracking-[0.6em] text-[#D9D1DB] mb-6 block">
              Experience Systems & Design
            </span>
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-black uppercase tracking-tighter leading-[0.85] mb-6">
              Architecting<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D9D1DB] via-[#7C4DFF] to-[#4918A9]">
                Intuition
              </span>
            </h1>
            <h2 className="text-2xl md:text-4xl font-light text-[#D9D1DB]/90 mb-12 tracking-tight italic leading-tight">
              Designing systems that think before users do.
            </h2>
            <p className="text-xl md:text-2xl text-gray-400 font-light leading-relaxed max-w-3xl border-l border-[#4918A9] pl-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8">
              ...
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-[#1A1A1A] leading-[0.95]">
                Architecture for <br />
                <span className="text-[#4918A9]">Human Potential.</span>
              </h2>
            ...
            <div className="lg:col-span-4 flex flex-col gap-10 lg:border-l lg:border-gray-100 lg:pl-16">
              <div className="group">
                <div className="text-5xl font-black text-[#1A1A1A] group-hover:text-[#4918A9] transition-colors">40%</div>
                <div className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-400 mt-2">Cognitive Load Reduction</div>
              </div>
              <div className="group">
                <div className="text-5xl font-black text-[#1A1A1A] group-hover:text-[#4918A9] transition-colors">95%</div>
      ...
      <section className="py-32 bg-[#1A1A1A] text-white overflow-hidden relative">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#4918A9]/90 to-[#1A1A1A]/70"></div>
        </div>

        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl">
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#D9D1DB] mb-4 block">Strategic Capability</span>
              ...
              <div className="flex gap-4 items-center">
                <div className="w-8 h-px bg-[#D9D1DB]"></div>
                <span className="text-[10px] font-black uppercase tracking-widest text-[#D9D1DB]">Evidence-Based Design</span>
              </div>
            </div>
            <button 
              onClick={onExploreProcess}
              className="px-12 py-6 bg-white text-[#1A1A1A] text-[12px] font-black uppercase tracking-[0.4em] hover:bg-[#D9D1DB] transition-all shadow-2xl shrink-0 group"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-gray-100 border border-gray-100">
            {[
              ...
              <div key={i} className="bg-white p-10 group hover:bg-[#1A1A1A] transition-all duration-500 flex flex-col justify-between min-h-[420px]">
                <div>
                  <div className="text-[10px] font-black uppercase tracking-[0.4em] text-[#4918A9] group-hover:text-[#D9D1DB] mb-8 transition-colors">
                    {item.metric}
                  </div>
      ...
      <section className="relative w-full py-32 md:py-48 bg-[#4918A9] overflow-hidden group text-white">
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#4918A9] via-[#4918A9]/80 to-[#1A1A1A]/95"></div>
        </div>

        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-24 items-center">
            
            <div className="lg:col-span-5 border-l-8 border-[#D9D1DB] pl-10 md:pl-16">
              <span className="text-[12px] font-black uppercase tracking-[0.6em] text-[#D9D1DB] mb-6 block">
                Enterprise Value Realization
              </span>
              <div className="text-8xl md:text-[140px] font-black tracking-tighter leading-none mb-4 group-hover:text-[#D9D1DB] transition-colors duration-700">
                100:1
              </div>
              <h3 className="text-xl md:text-2xl font-black uppercase tracking-widest text-[#D9D1DB] opacity-80">
            ...
            <div className="lg:col-span-7">
              ...
              <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter mb-10 leading-[0.9] text-white">
                Proven <span className="text-[#D9D1DB]">Impact</span>, <br />
                Quantifiable <span className="text-[#D9D1DB]">ROI</span>.
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 pt-12 border-t border-white/10">
                <div className="space-y-4">
                  <p className="text-[11px] font-black uppercase tracking-[0.4em] text-[#D9D1DB]">Success Benchmark</p>
                ...
                <div className="space-y-4">
                  <p className="text-[11px] font-black uppercase tracking-[0.4em] text-[#D9D1DB]">Efficiency Metric</p>
          ...
          <div className="bg-[#1A1A1A] p-12 md:p-20 shadow-2xl relative overflow-hidden text-white rounded-sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
              <div className="lg:col-span-5">
                <div className="accent-bar bg-[#D9D1DB] w-20 mb-8"></div>
                <div className="text-[10px] font-black text-[#D9D1DB] uppercase tracking-[0.5em] mb-4">Strategic Value Proposition</div>
                <h3 className="text-4xl md:text-7xl font-black uppercase tracking-tighter mb-8 leading-[0.9]">
                  Acquisition <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D9D1DB] to-[#7C4DFF]">Architecture</span>
                </h3>
                ...
                <div className="flex gap-4 p-6 bg-white/[0.03] border-l-4 border-[#7C4DFF]">
                  <div className="space-y-1">
                    <p className="text-[9px] font-black uppercase tracking-[0.3em] text-[#D9D1DB]">Portfolio Average</p>
                ...
                {[
                  ...
                  <div className="p-8 border border-white/10 bg-white/[0.02] hover:bg-white/[0.05] transition-all duration-300 group/card" key={item.title}>
                    <div className="text-[11px] font-black text-white mb-4 flex items-center gap-4">
                      <span className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center text-[10px] text-[#D9D1DB] group-hover/card:border-[#7C4DFF] group-hover/card:text-white transition-colors">
                        {item.icon}
                      </span>
                      <span className="tracking-[0.2em] uppercase group-hover/card:text-[#D9D1DB] transition-colors">
                        {item.title}
                      </span>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
            <div className="lg:col-span-8">
              ...
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter mb-10 leading-[0.85] text-[#1A1A1A]">
                AI Experience<br />
                <span className="text-[#4918A9]">Design (AIXD)</span>
              </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-gray-100 border border-gray-100">
            ...
            <div className="bg-white p-12 group hover:bg-[#1A1A1A] transition-all duration-700">
              <div className="mb-10 flex justify-between items-start">
                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#4918A9] group-hover:text-[#D9D1DB] transition-colors">Efficiency Layer</span>
                <div className="w-10 h-10 border border-[#4918A9]/20 flex items-center justify-center text-[#4918A9] group-hover:text-white transition-colors">01</div>
              </div>
              ...
              <div className="space-y-4 mb-12">
                {["Intent-Aware Routing", "Contextual Memory", "Semantic Reasoning"].map(item => (
                  <div key={item} className="flex items-center gap-3">
                    <div className="w-1 h-1 bg-[#4918A9] rounded-full group-hover:bg-[#D9D1DB] transition-colors"></div>
              ...
              <div className="pt-6 border-t border-gray-50 group-hover:border-white/10 transition-colors">
                <p className="text-[10px] font-black text-[#4918A9] group-hover:text-[#D9D1DB] uppercase tracking-[0.2em] mb-1">Impact</p>
            ...
            <div className="bg-white p-12 group hover:bg-[#1A1A1A] transition-all duration-700">
              <div className="mb-10 flex justify-between items-start">
                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#4918A9] group-hover:text-[#D9D1DB] transition-colors">Growth Layer</span>
                <div className="w-10 h-10 border border-[#4918A9]/20 flex items-center justify-center text-[#4918A9] group-hover:text-white transition-colors">02</div>
              </div>
            ...
            <div className="bg-white p-12 group hover:bg-[#1A1A1A] transition-all duration-700">
              <div className="mb-10 flex justify-between items-start">
                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#4918A9] group-hover:text-[#D9D1DB] transition-colors">Expansion Layer</span>
                <div className="w-10 h-10 border border-[#4918A9]/20 flex items-center justify-center text-[#4918A9] group-hover:text-white transition-colors">03</div>
              </div>
      ...
      <section className="py-48 bg-[#1A1A1A] text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
            <div className="lg:col-span-5">
              <div className="accent-bar bg-[#D9D1DB] w-20 mb-10"></div>
              <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-10 leading-[0.85]">
                Ethical UX <br />
                <span className="text-[#D9D1DB]">Architecture</span>
              </h2>
              ...
              <div className="space-y-10">
                {[
                  ...
                  <div key={i} className="flex gap-8 group/item">
                    <div className="text-2xl font-black text-[#D9D1DB]">0{i+1}</div>
                    <div>
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="p-12 border border-white/5 bg-white/[0.02] backdrop-blur-sm relative overflow-hidden">
                  <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-[#D9D1DB] mb-6">Retention Focus</h4>
                ...
                <div className="p-12 border border-white/5 bg-white/[0.02] backdrop-blur-sm relative overflow-hidden">
                  <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-[#D9D1DB] mb-6">Market Compliance</h4>
                ...
                <div className="md:col-span-2 p-12 bg-gradient-to-r from-[#1A1A1A] to-[#2A2A2A] border border-white/5">
                  <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    <button 
                      ...
                      className="px-8 py-4 border border-[#4918A9] text-[10px] font-black uppercase tracking-[0.3em] text-[#D9D1DB] hover:bg-[#4918A9] hover:text-white transition-all whitespace-nowrap"
                    >
                      Request Audit
                    </button>
                  </div>
      ...
      <section className="py-32 bg-white relative overflow-hidden border-y border-gray-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-10 leading-[1] text-[#1A1A1A]">
                The Cognitive <span className="text-[#4918A9]">Bridge</span>
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                <div className="p-8">
                    <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-[#4918A9] mb-4">01. Intuition</h4>
                ...
                <div className="p-8 md:border-x border-gray-100">
                    <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-[#4918A9] mb-4">02. Clarity</h4>
                ...
                <div className="p-8">
                    <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-[#4918A9] mb-4">03. Response</h4>
      ...
      <section className="relative w-full py-48 bg-[#0A0A0A] overflow-hidden group text-white">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-[#4918A9]/10 rounded-full blur-[120px] animate-pulse"></div>
          <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-[#D9D1DB]/5 rounded-full blur-[100px] animate-pulse [animation-delay:2s]"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-start">
            ...
            <div className="lg:col-span-5">
              <div className="accent-bar bg-gradient-to-r from-[#4918A9] to-[#D9D1DB] w-32 mb-12"></div>
              ...
              <p className="text-xl md:text-2xl text-gray-400 font-light leading-relaxed mb-16 border-l-4 border-[#4918A9] pl-10">
              ...
              <div className="relative p-12 bg-white/[0.03] border border-white/10 backdrop-blur-xl shadow-2xl">
                <div className="text-8xl md:text-[120px] font-black tracking-tighter leading-none mb-4 text-[#D9D1DB]">
                  32%
                </div>
                <h4 className="text-xs font-black uppercase tracking-[0.5em] text-[#4918A9] mb-4">Baseline Efficiency Gain</h4>
                <p className="text-sm text-gray-500 font-light leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/5 border border-white/10 overflow-hidden">
                {[
                  ...
                  <div className="p-10 bg-white/[0.02] hover:bg-white/[0.05] transition-all duration-700 flex flex-col justify-between group/card min-h-[340px]" key={i}>
                    <div>
                      <div className="w-14 h-14 border border-white/10 flex items-center justify-center text-xl font-black mb-8 group-hover/card:scale-110 group-hover/card:border-[#4918A9] transition-all" style={{ color: pillar.color }}>
                        {pillar.icon}
                      </div>
                      <h3 className="text-xl font-black uppercase tracking-tight mb-4 group-hover/card:text-[#D9D1DB] transition-colors">{pillar.title}</h3>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between p-12 bg-white/[0.03] backdrop-blur-md gap-12 border border-white/10 rounded-sm">
                ...
                <div className="flex shrink-0">
                    <button 
                        ...
                        className="px-12 py-6 bg-white text-[#1A1A1A] text-[12px] font-black uppercase tracking-[0.4em] hover:bg-[#4918A9] hover:text-white transition-all shadow-[0_20px_40px_rgba(255,255,255,0.1)] group"
                    >
      ...
      <section className="py-32 bg-white border-t border-gray-100 overflow-hidden relative text-center">
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-10 leading-tight text-[#1A1A1A]">
            Design the <span className="text-[#4918A9]">Untold</span> Story<br /> of your Enterprise.
          </h2>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button 
              onClick={onInitiateStrategy}
              className="px-12 py-5 bg-[#1A1A1A] text-white text-[12px] font-black uppercase tracking-[0.4em] hover:bg-[#4918A9] transition-all"
            >
