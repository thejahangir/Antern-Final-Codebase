...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="relative py-48 bg-white overflow-hidden selection:bg-[#4918A9] selection:text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 mb-32 items-end">
          <div className="lg:col-span-8">
            ...
            <span className="text-[12px] font-black uppercase tracking-[0.8em] text-[#4918A9] mb-8 block">The Antern Narrative</span>
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter leading-[0.8] text-[#1A1A1A]">
              Decades of <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1A1A1A] via-[#4918A9] to-[#7C4DFF]">
                Excellence.
              </span>
            </h2>
          </div>
          <div className="lg:col-span-4 pb-4">
            <div className="relative p-10 border-l border-gray-100 bg-gray-50/30">
              ...
              <div className="absolute top-0 left-0 w-2 h-2 bg-[#4918A9]"></div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-gray-100 border border-gray-100 mb-32">
          <div className="bg-white p-12 md:p-24 group hover:bg-[#1A1A1A] transition-all duration-700">
            <div className="flex items-center gap-6 mb-16">
              <div className="w-20 h-px bg-[#4918A9] group-hover:bg-white/30 transition-all group-hover:w-32"></div>
              <span className="text-[11px] font-black uppercase tracking-[0.5em] text-gray-400 group-hover:text-[#D9D1DB] transition-colors">Strategic Ops</span>
            </div>
          ...
          <div className="bg-white p-12 md:p-24 group hover:bg-[#4918A9] transition-all duration-700">
            <div className="flex items-center gap-6 mb-16">
              <div className="w-20 h-px bg-[#1A1A1A] group-hover:bg-white/30 transition-all group-hover:w-32"></div>
              <span className="text-[11px] font-black uppercase tracking-[0.5em] text-gray-400 group-hover:text-[#D9D1DB] transition-colors">Core Design</span>
            </div>
            <h3 className="text-4xl font-black uppercase tracking-tighter text-[#1A1A1A] group-hover:text-white mb-10 transition-colors leading-none">
        ...
        <div className="relative group overflow-hidden bg-[#1A1A1A] min-h-[600px] flex flex-col lg:flex-row items-stretch">
          ...
          <div className="lg:w-1/2 p-12 md:p-24 flex flex-col justify-center relative">
            <div className="absolute top-0 right-0 p-12 opacity-[0.03] text-[200px] font-black leading-none pointer-events-none">
              +
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
              <div className="relative">
                <span className="text-[10px] font-black uppercase tracking-[0.6em] text-[#4918A9] mb-4 block">Longevity</span>
                <div className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-none mb-4">10+</div>
                <p className="text-gray-500 text-sm font-medium uppercase tracking-widest">Years of strategic presence</p>
              </div>
              <div className="relative">
                <span className="text-[10px] font-black uppercase tracking-[0.6em] text-[#4918A9] mb-4 block">Velocity</span>
                <div className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-none mb-4">500+</div>
                <p className="text-gray-500 text-sm font-medium uppercase tracking-widest">Digital systems delivered</p>
              </div>
              <div className="relative">
                <span className="text-[10px] font-black uppercase tracking-[0.6em] text-[#4918A9] mb-4 block">Scale</span>
                <div className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-none mb-4">24/7</div>
                <p className="text-gray-500 text-sm font-medium uppercase tracking-widest">Operational Intelligence sync</p>
              </div>
              <div className="relative">
                <span className="text-[10px] font-black uppercase tracking-[0.6em] text-[#4918A9] mb-4 block">Quality</span>
                <div className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-none mb-4">01</div>
                <p className="text-gray-500 text-sm font-medium uppercase tracking-widest">Unified Excellence standard</p>
              </div>
            </div>
