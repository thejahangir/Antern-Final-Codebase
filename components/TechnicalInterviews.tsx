  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center bg-[#0A0A0A] overflow-hidden">
        ...
        >
          <img 
            src="https://images.unsplash.com/photo-1714976694781-216bfc30214e?q=80&w=2400&auto=format&fit=crop" 
          ...
          <div className="absolute inset-0 opacity-[0.05]" 
               style={{ backgroundImage: 'linear-gradient(0deg, transparent 24%, rgba(73, 24, 169, .3) 25%, rgba(73, 24, 169, .3) 26%, transparent 27%, transparent 74%, rgba(73, 24, 169, .3) 75%, rgba(73, 24, 169, .3) 76%, transparent 77%, transparent), linear-gradient(90deg, transparent 24%, rgba(73, 24, 169, .3) 25%, rgba(73, 24, 169, .3) 26%, transparent 27%, transparent 74%, rgba(73, 24, 169, .3) 75%, rgba(73, 24, 169, .3) 76%, transparent 77%, transparent)', backgroundSize: '50px 50px' }}>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
            <div className="lg:col-span-5">
              ...
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-[#1A1A1A] leading-[0.95] mb-12">
                The Interview <br />
                <span className="text-[#4918A9]">OS.</span>
              </h2>
              <div className="space-y-10">
                {[
                  ...
                  <div key={i} className="group">
                    <h3 className="text-xl font-bold uppercase tracking-tight text-[#1A1A1A] mb-2 group-hover:text-[#4918A9] transition-colors">{item.title}</h3>
            ...
            <div className="lg:col-span-7">
              <div className="relative aspect-[4/3] bg-[#1A1A1A] border border-gray-100 overflow-hidden shadow-2xl">
                {/* Abstract Code UI */}
                ...
                <div className="p-12 mt-8 font-mono text-sm text-gray-400">
                  <span className="text-[#4918A9]">const</span> <span className="text-[#D9D1DB]">evaluateCandidate</span> = <span className="text-[#4918A9]">async</span> (profile) ={'>'} {'{'}
                  <br />
                  &nbsp;&nbsp;<span className="text-[#4918A9]">const</span> skills = <span className="text-[#4918A9]">await</span> extractSkills(profile.dossier);
                  <br />
                  &nbsp;&nbsp;<span className="text-[#4918A9]">const</span> score = calculateVelocity(skills, benchmarks);
                  <br />
                  &nbsp;&nbsp;<span className="text-gray-600">// Real-time heuristic analysis</span>
                  <br />
                  &nbsp;&nbsp;<span className="text-[#4918A9]">return</span> score {'>'} 95 ? <span className="text-green-400">'HIRE'</span> : <span className="text-red-400">'PASS'</span>;
                  <br />
                  {'}'}
                </div>
                {/* Floating Metrics */}
                <div className="absolute bottom-10 right-10 bg-white p-6 shadow-xl border-l-4 border-[#4918A9]">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-10 border-t-4 border-[#4918A9] hover:shadow-lg transition-all cursor-default">
                <span className="text-5xl font-black text-gray-100 mb-6 block">{s.step}</span>
      ...
      <section className="py-48 bg-[#1A1A1A] text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter text-white mb-10 leading-none">
            Hire with <br /><span className="text-[#D9D1DB]">Certainty.</span>
          </h2>
          <button 
            onClick={onInitiateStrategy}
            className="px-12 py-6 bg-white text-[#1A1A1A] text-[12px] font-black uppercase tracking-[0.5em] hover:bg-[#4918A9] hover:text-white transition-all"
          >
            Schedule Demo
          </button>
        </div>
