  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center bg-[#0A0A0A] overflow-hidden">
        ...
        >
          <img 
            src="https://images.unsplash.com/photo-1666816584311-ba40d5299760?q=80&w=2400&auto=format&fit=crop" 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7">
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-[#1A1A1A] leading-[0.95] mb-12">
                Digital <span className="text-[#4918A9]">Sovereignty</span> <br /> 
                over Digital Noise.
              </h2>
              ...
              <div className="flex gap-4 p-8 bg-gray-50 border-l-4 border-[#4918A9]">
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="absolute -bottom-10 -left-10 w-24 h-24 bg-[#4918A9] flex items-center justify-center text-white text-5xl font-light shadow-2xl">
                +
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200 border border-gray-200">
            {[
              ...
              <div key={pillar.id} className="bg-white p-12 hover:bg-[#1A1A1A] group transition-all duration-700">
                <span className="text-4xl font-black text-[#4918A9] group-hover:text-[#D9D1DB] transition-colors mb-8 block">
                  {pillar.id}
                </span>
                ...
                <div className="mt-12 h-1 bg-gray-100 w-12 group-hover:w-full group-hover:bg-[#4918A9] transition-all duration-700"></div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
            <div className="lg:col-span-4">
              ...
              <h2 className="text-5xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-8">
                The<br />
                <span className="text-[#4918A9]">Roadmap</span><br />
                to 2030
              </h2>
              ...
              <div className="space-y-24 relative">
                ...
                {[
                  ...
                  <div key={i} className="relative pl-12 group">
                    <div className="absolute left-[-4px] top-0 w-2 h-2 rounded-full bg-gray-200 group-hover:bg-[#4918A9] group-hover:scale-150 transition-all"></div>
                    <span className="text-[11px] font-black uppercase tracking-[0.4em] text-[#4918A9] mb-4 block">
                      {item.year}
                    </span>
      ...
      {/* Immersive CTA */}
      <section className="relative py-48 bg-[#0A0A0A] overflow-hidden group">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tighter text-white leading-[0.85] mb-12">
            Share the <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D9D1DB] to-[#4918A9]">Manifesto.</span>
          </h2>
          ...
          <button 
            ...
            className="px-16 py-6 bg-white text-[#1A1A1A] text-[12px] font-black uppercase tracking-[0.5em] hover:bg-[#4918A9] hover:text-white transition-all shadow-2xl group"
          >
