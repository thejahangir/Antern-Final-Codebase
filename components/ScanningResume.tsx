  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center bg-[#0A0A0A] overflow-hidden">
        ...
        >
          <img 
            src="https://images.unsplash.com/photo-1698047681432-006d2449c631?q=80&w=2400&auto=format&fit=crop" 
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
               <div className="absolute top-0 -left-10 w-full h-full border-2 border-[#D9D1DB] opacity-50"></div>
               <div className="bg-white p-12 shadow-2xl relative z-10">
                 <h3 className="text-xs font-black uppercase tracking-[0.4em] text-[#4918A9] mb-8">Input Stream</h3>
                 ...
                 <div className="flex flex-col gap-4">
                   <div className="flex items-center justify-between p-3 bg-gray-50 border border-gray-100">
                     ...
                     <span className="text-green-600 font-mono">Detected (0.98)</span>
                   </div>
                   <div className="flex items-center justify-between p-3 bg-gray-50 border border-gray-100">
                     <span className="font-bold text-[#1A1A1A]">Kubernetes</span>
                     <span className="text-green-600 font-mono">Detected (0.99)</span>
                   </div>
                   <div className="flex items-center justify-between p-3 bg-gray-50 border border-gray-100">
                     <span className="font-bold text-[#1A1A1A]">Architecture</span>
                     <span className="text-green-600 font-mono">Inferred (0.95)</span>
                   </div>
                 </div>
               </div>
            </div>
            ...
            <div>
              <h2 className="text-4xl font-black uppercase tracking-tighter text-[#1A1A1A] mb-8">Contextual <span className="text-[#4918A9]">Understanding.</span></h2>
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-center gap-4">
                    <div className="w-1.5 h-1.5 bg-[#4918A9] rotate-45"></div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className="accent-bar bg-[#4918A9] mx-auto w-12 mb-8"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="p-8 group">
              <div className="w-20 h-20 bg-[#1A1A1A] text-white flex items-center justify-center text-3xl font-black mx-auto mb-8 rounded-full group-hover:bg-[#4918A9] transition-colors">1</div>
            ...
            <div className="p-8 group">
              <div className="w-20 h-20 bg-[#1A1A1A] text-white flex items-center justify-center text-3xl font-black mx-auto mb-8 rounded-full group-hover:bg-[#4918A9] transition-colors">2</div>
            ...
            <div className="p-8 group">
              <div className="w-20 h-20 bg-[#1A1A1A] text-white flex items-center justify-center text-3xl font-black mx-auto mb-8 rounded-full group-hover:bg-[#4918A9] transition-colors">3</div>
      ...
      <section className="py-48 bg-[#1A1A1A] relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter text-white mb-12">
            Process <span className="text-[#4918A9]">Faster.</span>
          </h2>
          <button 
